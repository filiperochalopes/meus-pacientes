...
const LabTestForm = () => {
  const [id, setId] = React.useState(null),
    ...
    [getLabTestArrival, { data: labTestArrivalList }] =
    ...
    formik = useFormik({
      ...
      onSubmit: async (values, { resetForm }) => {
        ...
        enqueueSnackbar("Cadastrado editado com sucesso!", {
          variant: "success",
        });
        getLabTestArrival();
        setId(null);
  ...
  useEffect(() => {
    if (id) {
      formik.setValues({
        id,
        arrivalDate:
          labTestArrivalList.getLabTestArrival.find((e) => e.id === id)
            ?.arrivalDate || "",
        labTestDate:
          labTestArrivalList.getLabTestArrival.find((e) => e.id === id)
            ?.labTestDate || "",
        patientName:
          labTestArrivalList.getLabTestArrival.find((e) => e.id === id)?.patient
            .name || "",
        patientDob:
          labTestArrivalList.getLabTestArrival.find((e) => e.id === id)?.patient
            .dob || "",
  ...
  return (
    <LYTSimplePage title="Cadastro de Exames">
      ...
      {!id &&
        labTestArrivalList?.getLabTestArrival.map((e) => (
