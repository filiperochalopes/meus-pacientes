...
def upgrade():
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=True),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=True),
    sa.ForeignKeyConstraint(['community_health_agent_id'], ['users.id'], ),
    sa.ForeignKeyConstraint(['institution_id'], ['institutions.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('cns'),
    sa.UniqueConstraint('cpf'),
    ...
    op.create_table('active_targets',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('patient_id', sa.Integer(), nullable=True),
    ...
    op.create_table('continuous_prescriptions',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_table('patient_comorbidities',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('patient_id', sa.Integer(), nullable=True),
    ...
    sa.Column('observations', sa.String(), nullable=True),
    sa.ForeignKeyConstraint(['patient_id'], ['patients.id'], ),
    sa.ForeignKeyConstraint(['risk_id'], ['risk_levels.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('patient_lab_tests',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('patient_id', sa.Integer(), nullable=True),
    ...
    op.create_table('pregnancy_lab_tests',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_table('ultrasonographies',
    sa.Column('id', sa.Integer(), nullable=False),
