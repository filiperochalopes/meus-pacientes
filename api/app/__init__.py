...
def seed():
    ...
    with open(
        os.path.join(os.path.dirname(__file__), "assets", "CID-10-DATASUS.csv"),
        "r",
        encoding="ISO-8859-1",
    ) as file:
    ...
    comorbidities = [
        Comorbidity(
            name="diabetes",
            abbreviation="DM",
            description="Diabetes Mellitus Tipo 1 ou 2 (DM)",
        ),
        Comorbidity(
            name="hipertensão",
            abbreviation="HAS",
            description="Hipertensão Arterial Sistêmica (HAS)",
        ),
        Comorbidity(
            name="epilepsia",
            abbreviation="EPL",
    ...
    lab_tests = [
        ...
        LabTest(
            name="Teste oral tolerância a glicose (75g dextrose 0/60/120)",
            abbreviation="TOTG",
        ),
        ...
        LabTest(
            name="SWAB Vaginal e Retal para cultura de Estreptococo Grupo B/GBS",
            abbreviation="Cult Strepto B",
        ),
    ]
